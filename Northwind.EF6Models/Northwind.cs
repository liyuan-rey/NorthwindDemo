...
namespace Northwind.EF6Models
{
    ...
    // Alphabetical list of products
    public partial class AlphabeticalListOfProductConfiguration : EntityTypeConfiguration<AlphabeticalListOfProduct>
    {
    ...
    // Category Sales for 1997
    public partial class CategorySalesFor1997Configuration : EntityTypeConfiguration<CategorySalesFor1997>
    {
    ...
    // Current Product List
    public partial class CurrentProductListConfiguration : EntityTypeConfiguration<CurrentProductList>
    {
    ...
    // Customer and Suppliers by City
    public partial class CustomerAndSuppliersByCityConfiguration : EntityTypeConfiguration<CustomerAndSuppliersByCity>
    {
    ...
    // Order Details Extended
    public partial class OrderDetailsExtendedConfiguration : EntityTypeConfiguration<OrderDetailsExtended>
    {
    ...
    // Orders Qry
    public partial class OrdersQryConfiguration : EntityTypeConfiguration<OrdersQry>
    {
    ...
    // Order Subtotals
    public partial class OrderSubtotalConfiguration : EntityTypeConfiguration<OrderSubtotal>
    {
    ...
    // Products Above Average Price
    public partial class ProductsAboveAveragePriceConfiguration : EntityTypeConfiguration<ProductsAboveAveragePrice>
    {
    ...
    // Product Sales for 1997
    public partial class ProductSalesFor1997Configuration : EntityTypeConfiguration<ProductSalesFor1997>
    {
    ...
    // Products by Category
    public partial class ProductsByCategoryConfiguration : EntityTypeConfiguration<ProductsByCategory>
    {
    ...
    // Sales by Category
    public partial class SalesByCategoryConfiguration : EntityTypeConfiguration<SalesByCategory>
    {
    ...
    // Sales Totals by Amount
    public partial class SalesTotalsByAmountConfiguration : EntityTypeConfiguration<SalesTotalsByAmount>
    {
    ...
    // Shippers
    public partial class ShipperConfiguration : EntityTypeConfiguration<Shipper>
    {
    ...
    // Summary of Sales by Quarter
    public partial class SummaryOfSalesByQuarterConfiguration : EntityTypeConfiguration<SummaryOfSalesByQuarter>
    {
    ...
    // Summary of Sales by Year
    public partial class SummaryOfSalesByYearConfiguration : EntityTypeConfiguration<SummaryOfSalesByYear>
    {
    ...
    // Suppliers
    public partial class SupplierConfiguration : EntityTypeConfiguration<Supplier>
    {
    ...
    // Territories
    public partial class TerritoryConfiguration : EntityTypeConfiguration<Territory>
    {
